...
<main class="products-main">
    ...
    <div class="filter-container">
        <button class="btn filter-btn <?= $requested_filter === 'all' ? 'btn-primary' : 'btn-outline' ?>"
            data-filter="all">All Products</button>
        <?php foreach ($categories as $slug => $name): ?>
            <button class="btn filter-btn <?= $requested_filter === $slug ? 'btn-primary' : 'btn-outline' ?>"
                data-filter="<?= htmlspecialchars($slug) ?>"><?= htmlspecialchars($name) ?></button>
        <?php endforeach; ?>
    </div>
    ...
    <div class="product-grid" id="product-grid">
        <?php foreach ($products as $product): ?>
            ...
            <a href="product.php?id=<?= urlencode($product['id']) ?>"
                class="product-card product-item-filter <?= htmlspecialchars($cat_class_string) ?>">
